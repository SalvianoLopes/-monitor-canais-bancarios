...
- **Pendência em aberto (30/07/2026, não esclarecida ainda):** Salviano mencionou "temos 8 acessos" (hoje são 6) e pediu pra trocar o e-mail de login (hoje fixo em `sao-atendimento@inbursa.com`) — perguntei duas vezes o que exatamente mudar e ainda não veio resposta clara. **Não mexer em nada disso até ele confirmar**: (1) se são mais 2 contas pra criar ou se ele está contando diferente, e (2) pra qual e-mail trocar e se troca nas 6 contas existentes ou só no texto exibido na tela.
